...
class FichePrestation(models.Model):
    ...
    consultations = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    echographie_prescripteur = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    echographie_acteur =models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
