# Generated by Django 5.2.1 on 2025-06-28 14:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Accouchement', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('actes', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('prescriptions_laboratoire', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('prime_hospitalisation', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
