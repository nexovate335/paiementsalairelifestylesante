...
class FicheDePaie(models.Model):
    ...
    # Prestations
    prestations = models.DecimalField(max_digits=10, decimal_places=2, default=0, null=True, blank=True)
    transport_jour = models.DecimalField(max_digits=10, decimal_places=2, default=0, null=True, blank=True)
    transport_nuit_feries = models.DecimalField(max_digits=10, decimal_places=2, default=0, null=True, blank=True)
    autres_prestations = models.DecimalField(max_digits=10, decimal_places=2, default=0, null=True, blank=True)
    prime_anciennete = models.DecimalField(max_digits=10, decimal_places=2, default=0, null=True, blank=True)
