...
class FicheDePaie(models.Model):
    ...
    bonus_prestations = models.DecimalField(max_digits=10, decimal_places=2, default=0, null=True, blank=True)
    transport_reunion = models.DecimalField(max_digits=10, decimal_places=2, default=0, null=True, blank=True)
    prime_informatique = models.DecimalField(max_digits=10, decimal_places=2, default=0, null=True, blank=True)
    prime_responsabilite = models.DecimalField(max_digits=10, decimal_places=2, default=0, null=True, blank=True)
    ...
    def total_avant_retenues(self):
        champs = [
            ...
            self.bonus_prestations,
            self.transport_reunion,
            self.prime_informatique,
            self.prime_responsabilite,
            self.prime_transport,
            self.anciennete
        ]
        return sum([c or 0 for c in champs])  # évite les erreurs si champ est None
